...
DEFINE_LOGGER_DEVICE(log_events, LOGGER_LOG_EVENTS, 32*1024) //256
DEFINE_LOGGER_DEVICE(log_radio, LOGGER_LOG_RADIO, 8*1024)    //64
DEFINE_LOGGER_DEVICE(log_system, LOGGER_LOG_SYSTEM, 64*1024)
DEFINE_LOGGER_DEVICE(log_exception, LOGGER_LOG_EXCEPTION, 8*1024)
DEFINE_LOGGER_DEVICE(log_power, LOGGER_LOG_POWER, 8*1024)
#endif
